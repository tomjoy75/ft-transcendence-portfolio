...
export function renderHome() {
    var _a;
    const username = ((_a = state.currentUser) === null || _a === void 0 ? void 0 : _a.username) || 'Unknown';
    return `
	<section class="max-w-4xl mx-auto mt-10 p-6 bg-gray-900 text-white rounded-lg shadow-lg animate-fadeIn">
		<h1 class="text-4xl font-bold text-blue-400 mb-4 text-center">Welcome, ${username}!</h1>
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
			...
			<div class="bg-gray-800 p-4 rounded-lg shadow hover:shadow-md transition animate-fadeIn delay-300">
				<h2 class="text-xl font-semibold text-purple-400 mb-2">📊 Your Stats</h2>
				<p class="text-gray-300 text-sm">Track your performance, win/loss ratio, and improve over time.</p>
				<div class="mt-4 text-center">
					<a href="#/stats" class="inline-block px-6 py-2 bg-green-600 text-white rounded hover:bg-pink-700 transition">
						📈 View Stats
					</a>
				</div>
			</div>

			<div class="bg-gray-800 p-4 rounded-lg shadow hover:shadow-md transition animate-fadeIn delay-500">
				<h2 class="text-xl font-semibold text-green-400 mb-2">❌⭕ Tic Tac Toe</h2>
				<p class="text-gray-300 text-sm">Challenge a friend locally in a strategic grid game.</p>
				<div class="mt-4 text-center">
					<a href="#/tictactoe" class="inline-block px-6 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition">
						▶️ Play Tic Tac Toe
					</a>
				</div>
			</div>
